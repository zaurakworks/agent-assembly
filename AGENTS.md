...
本仓库用于维护辅助装配 Agent 的项目内声明和能力面。中文导航见 `README.md`；`.cap/capabilities/skills/*/SKILL.md` 使用中文并作为唯一执行合同。
...
- 快速迭代阶段只维护中文 `SKILL.md` 全文合同；稳定机器 id、路径、命令和配置键保持规范形式。不维护需要逐项同步的另一语言全文镜像。
